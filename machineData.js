const machineData = {
  "VENUS 6": {
    ...
    "P81": {
      "Robotic Arm Places Unit On Nest Despite Existing Unit.": [
        {
          "verification": [
            "Check sensor alignment",
            "Check sensor response",
            "Check PLC logic",
            "Check for mechanical delay"
          ],
          "solution": [
            "Ensure the sensor is properly aligned with the nest",
    ...
    "P87": {
      "Laser Not Clear On Unit": [
        {
          "verification": [
            "Ensure the lens is clean and free from dust, oil, or residue",
            "Inspect the unit\u2019s surface for contamination, coating, or irregular texture that may affect marking clarity"
          ],
          "solution": [
            "Clean the laser lens using approved cleaning tools and solution",
            "Clean or replace units with poor surface quality."
          ]
        }
      ]
    },
    "P88": {
      "Robotic Arm Not Picking Up Unit": [
        {
          "verification": [
            "Check sensor alignment",
            "Check sensor response",
